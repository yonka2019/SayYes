...
| Route | Who | What |
|---|---|---|
| `/{locale}` | creator | Builder (the home page): her/him toggle, name, email, one of six characters, gate question, questions with 2–6 options each, in `{locale}` → generates the link |
